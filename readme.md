...
* Откройте окно настройки параметров (Файл\Параметры\) ![Alt text](files/img/paramsmso.png)
* Включите панель разработчика в ленте. (Файл\Параметры\Настроить ленту, [x] Разработчик)![Рис.](files/img/ribmso.png)
* Проверьте настройки безопасности Outlook ![Рис.](files/img/permmso.png)
* Интегрируйте **Outlook VBA script.bas** в Microsoft Outlook через редактор VBA. (\File\Import file)

  * Шаг 1
![Alt text](files/img/pl1.png)
  * Шаг 2
![Alt text](files/img/pl2.png)
  *  Шаг 3
![Alt text](files/img/pl3.png)
  * Шаг 4
![Alt text](files/img/pl4.png)
...
* Запустите скрипт из Outlook ![Alt text](files/img/macromso.png), он предложит выбрать файл **list.xlsx** и mail **template.docx**.
